=head1 AmiGO::External::JSON::Solr::GOlr::BulkSearch

Search for and accumulate a large number of documents by checking a
set of fields for identifiers.

=cut

package AmiGO::External::JSON::Solr::GOlr::BulkSearch;
