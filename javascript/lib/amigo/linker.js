 ...
 *  xid - *[optional]* an internal transformation id
 *  type - *[serially optional]* 'url' or 'html'; defaults to url if not defined
 * 
 * Returns:
 *  string (url or link); null if it couldn't create anything
 */
amigo.linker_old = function (args, xid, type){
    ...
    /// These are the ones hard-coded for us.
    ///
