...
amigo.data.server = function(){
    ...
    var meta_data = {"html_base":"http://localhost:9999/static","species_map":{},"bbop_img_star":"http://localhost:9999/static/images/star.png","css_base":"http://localhost:9999/static/css","image_base":"http://localhost:9999/static/images","ontologies":[],"term_regexp":"all|GO:[0-9]{7}","species":[],"sources":[],"js_dev_base":"http://localhost:9999/static/staging","golr_base":"http://localhost:8080/solr/","galaxy_base":"http://galaxy.berkeleybop.org/","evidence_codes":{},"gp_types":[],"beta":"1","app_base":"http://localhost:9999","js_base":"http://localhost:9999/static/js"};
