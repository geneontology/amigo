...
amigo.data.server = function(){
    ...
    var meta_data = {"image_base":"http://localhost:9999/static/images","css_base":"http://localhost:9999/static/css","gp_types":[],"term_regexp":"all|GO:[0-9]{7}","js_base":"http://localhost:9999/static/js","ontologies":[],"species":[],"sources":[],"evidence_codes":{},"galaxy_base":"http://galaxy.berkeleybop.org/","js_dev_base":"http://localhost:9999/static/staging","app_base":"http://localhost:9999","bbop_img_star":"http://localhost:9999/static/images/star.png","html_base":"http://localhost:9999/static","beta":"1","species_map":{},"golr_base":"http://localhost:8080/solr/"};
