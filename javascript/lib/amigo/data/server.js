...
amigo.data.server = function(){
    ...
    var meta_data = {"galaxy_base":"http://galaxy.berkeleybop.org/","js_dev_base":"http://localhost:9999/static/staging","image_base":"http://localhost:9999/static/images","js_base":"http://localhost:9999/static/js","bbop_img_star":"http://localhost:9999/static/images/star.png","noctua_base":"http://noctua.berkeleybop.org/","sources":[],"golr_base":"http://localhost:8080/solr/","species":[],"html_base":"http://localhost:9999/static","css_base":"http://localhost:9999/static/css","ontologies":[],"species_map":{},"term_regexp":"all|GO:[0-9]{7}","beta":"1","gp_types":[],"app_base":"http://localhost:9999","evidence_codes":{}};
