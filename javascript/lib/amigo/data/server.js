...
amigo.data.server = function(){
    ...
    var meta_data = {"app_base":"http://localhost:9999","galaxy_base":"http://galaxy.berkeleybop.org/","beta":"1","js_base":"http://localhost:9999/static/js","evidence_codes":{},"js_dev_base":"http://localhost:9999/static/staging","sources":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","gp_types":[],"css_base":"http://localhost:9999/static/css","image_base":"http://localhost:9999/static/images","html_base":"http://localhost:9999/static","species":[],"ontologies":[],"species_map":{},"golr_base":"http://localhost:8080/solr/","term_regexp":"all|GO:[0-9]{7}"};
