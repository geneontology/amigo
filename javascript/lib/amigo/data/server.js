...
amigo.data.server = function(){
    ...
    var meta_data = {"species":[],"css_base":"http://localhost:9999/static/css","js_dev_base":"http://localhost:9999/static/staging","evidence_codes":{},"html_base":"http://localhost:9999/static","term_regexp":"all|GO:[0-9]{7}","species_map":{},"bbop_img_star":"http://localhost:9999/static/images/star.png","sources":[],"golr_base":"http://localhost:8080/solr/","ontologies":[],"app_base":"http://localhost:9999","js_base":"http://localhost:9999/static/js","beta":"1","gp_types":[],"image_base":"http://localhost:9999/static/images","galaxy_base":"http://galaxy.berkeleybop.org/"};
