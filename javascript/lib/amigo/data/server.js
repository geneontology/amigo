...
amigo.data.server = function(){
    ...
    var meta_data = {"noctua_base":"http://noctua-dev.berkeleybop.org/","app_base":"http://localhost:9999","golr_base":"http://localhost:8080/solr/","species_map":{},"ontologies":[],"sources":[],"html_base":"http://localhost:9999/static","galaxy_base":"http://galaxy.berkeleybop.org/","js_base":"http://localhost:9999/static/js","evidence_codes":{},"gp_types":[],"css_base":"http://localhost:9999/static/css","bbop_img_star":"http://localhost:9999/static/images/star.png","term_regexp":"all|GO:[0-9]{7}","js_dev_base":"http://localhost:9999/static/staging","image_base":"http://localhost:9999/static/images","beta":"1","species":[]};
