...
amigo.data.server = function(){
    ...
    var meta_data = {"evidence_codes":{},"js_dev_base":"http://localhost:9999/static/staging","js_base":"http://localhost:9999/static/js","app_base":"http://localhost:9999","ontologies":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","html_base":"http://localhost:9999/static","gp_types":[],"galaxy_base":null,"term_regexp":"all|GO:[0-9]{7}","species_map":{},"image_base":"http://localhost:9999/static/images","golr_base":"http://localhost:8080/solr/","css_base":"http://localhost:9999/static/css","sources":[],"species":[],"beta":"1"};
