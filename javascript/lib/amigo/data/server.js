...
amigo.data.server = function(){
    ...
    var meta_data = {"sources":[],"app_base":"http://localhost:9999","term_regexp":"all|GO:[0-9]{7}","noctua_base":"http://noctua.berkeleybop.org/","golr_base":"http://localhost:8080/solr/","evidence_codes":{},"beta":"1","html_base":"http://localhost:9999/static","gp_types":[],"browse_filter_idspace":"GO","species_map":{},"js_base":"http://localhost:9999/static/js","species":[],"js_dev_base":"http://localhost:9999/static/staging","galaxy_base":"http://galaxy.berkeleybop.org/","css_base":"http://localhost:9999/static/css","bbop_img_star":"http://localhost:9999/static/images/star.png","ontologies":[],"image_base":"http://localhost:9999/static/images"};
     ...
     *  string
     */
    var browse_filter_idspace = meta_data.browse_filter_idspace;
    this.browse_filter_idspace = function(){ return browse_filter_idspace; };
