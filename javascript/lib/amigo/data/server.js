...
amigo.data.server = function(){
    ...
    var meta_data = {"app_base":"http://localhost:9999","species":[],"css_base":"http://localhost:9999/static/css","gp_types":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","beta":"1","evidence_codes":{},"ontologies":[],"species_map":{},"term_regexp":"all|GO:[0-9]{7}","golr_base":"http://localhost:8080/solr/","image_base":"http://localhost:9999/static/images","galaxy_base":null,"html_base":"http://localhost:9999/static","js_dev_base":"http://localhost:9999/static/staging","sources":[],"js_base":"http://localhost:9999/static/js"};
