...
amigo.data.server = function(){
    ...
    var meta_data = {"bbop_img_star":"http://localhost:9999/static/images/star.png","js_dev_base":"http://localhost:9999/static/staging","js_base":"http://localhost:9999/static/js","term_regexp":"all|GO:[0-9]{7}","galaxy_base":null,"image_base":"http://localhost:9999/static/images","species_map":{},"species":[],"app_base":"http://localhost:9999","css_base":"http://localhost:9999/static/css","golr_base":"http://localhost:8080/solr/","gp_types":[],"ontologies":[],"sources":[],"beta":"1","html_base":"http://localhost:9999/static","evidence_codes":{}};
