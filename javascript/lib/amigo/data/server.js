...
amigo.data.server = function(){
    ...
    var meta_data = {"beta":"1","gp_types":[],"golr_base":"http://localhost:8080/solr/","species":[],"ontologies":[],"app_base":"http://localhost:9999","js_dev_base":"http://localhost:9999/static/staging","html_base":"http://localhost:9999/static","species_map":{},"image_base":"http://localhost:9999/static/images","css_base":"http://localhost:9999/static/css","js_base":"http://localhost:9999/static/js","bbop_img_star":"http://localhost:9999/static/images/star.png","evidence_codes":{},"sources":[],"galaxy_base":null,"term_regexp":"all|GO:[0-9]{7}"};
