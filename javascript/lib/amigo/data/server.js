...
amigo.data.server = function(){
    ...
    var meta_data = {"js_dev_base":"http://localhost:9999/static/staging","js_base":"http://localhost:9999/static/js","species_map":{},"ontologies":[],"golr_base":"http://localhost:8080/solr/","bbop_img_star":"http://localhost:9999/static/images/star.png","evidence_codes":{},"sources":[],"species":[],"css_base":"http://localhost:9999/static/css","image_base":"http://localhost:9999/static/images","beta":"1","galaxy_base":"http://galaxy.berkeleybop.org/","gp_types":[],"html_base":"http://localhost:9999/static","app_base":"http://localhost:9999","term_regexp":"all|GO:[0-9]{7}"};
