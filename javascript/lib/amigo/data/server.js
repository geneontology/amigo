...
amigo.data.server = function(){
    ...
    var meta_data = {"js_dev_base":"http://localhost:9999/static/staging","css_base":"http://localhost:9999/static/css","ontologies":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","species":[],"image_base":"http://localhost:9999/static/images","html_base":"http://localhost:9999/static","galaxy_base":null,"gp_types":[],"term_regexp":"all|GO:[0-9]{7}","beta":"1","golr_base":"http://localhost:8080/solr/","js_base":"http://localhost:9999/static/js","species_map":{},"evidence_codes":{},"app_base":"http://localhost:9999","sources":[]};
