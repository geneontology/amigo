...
amigo.data.server = function(){
    ...
    var meta_data = {"beta":"1","galaxy_base":"http://galaxy.berkeleybop.org/","js_dev_base":"http://localhost:9999/static/staging","js_base":"http://localhost:9999/static/js","golr_base":"http://localhost:8080/solr/","html_base":"http://localhost:9999/static","species_map":{},"species":[],"gp_types":[],"image_base":"http://localhost:9999/static/images","app_base":"http://localhost:9999","css_base":"http://localhost:9999/static/css","ontologies":[],"evidence_codes":{},"sources":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","term_regexp":"all|GO:[0-9]{7}"};
