...
amigo.data.server = function(){
    ...
    var meta_data = {"term_regexp":"all|GO:[0-9]{7}","evidence_codes":{},"html_base":"http://localhost:9999/static","ontologies":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","golr_base":"http://localhost:8080/solr/","js_dev_base":"http://localhost:9999/static/staging","css_base":"http://localhost:9999/static/css","beta":"1","gp_types":[],"sources":[],"species_map":{},"species":[],"galaxy_base":"http://galaxy.berkeleybop.org/","js_base":"http://localhost:9999/static/js","app_base":"http://localhost:9999","image_base":"http://localhost:9999/static/images"};
