...
amigo.data.server = function(){
    ...
    var meta_data = {"bbop_img_star":"http://localhost/amigo2/images/star.png","gp_types":[],"ontologies":[],"sources":[],"html_base":"http://localhost/amigo2","beta":"1","species_map":{},"app_base":"http://localhost/cgi-bin/amigo2","image_base":"http://localhost/amigo2/images","species":[],"term_regexp":"^all$|^GO:[0-9]{7}$","evidence_codes":{},"golr_base":"http://localhost:8080/solr/","galaxy_base":"http://galaxy.berkeleybop.org/"};
