...
amigo.data.server = function(){
    ...
    var meta_data = {"app_base":"http://localhost:9999","css_base":"http://localhost:9999/static/css","golr_base":"http://localhost:8080/solr/","gp_types":[],"species_map":{},"species":[],"beta":"1","evidence_codes":{},"js_dev_base":"http://localhost:9999/static/staging","term_regexp":"all|GO:[0-9]{7}","html_base":"http://localhost:9999/static","bbop_img_star":"http://localhost:9999/static/images/star.png","galaxy_base":"http://galaxy.berkeleybop.org/","ontologies":[],"sources":[],"js_base":"http://localhost:9999/static/js","image_base":"http://localhost:9999/static/images"};
