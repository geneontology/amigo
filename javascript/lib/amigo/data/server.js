...
amigo.data.server = function(){
    ...
    var meta_data = {"js_base":"http://localhost:9999/static/js","css_base":"http://localhost:9999/static/css","app_base":"http://localhost:9999","species_map":{},"beta":"1","gp_types":[],"html_base":"http://localhost:9999/static","bbop_img_star":"http://localhost:9999/static/images/star.png","js_dev_base":"http://localhost:9999/static/staging","evidence_codes":{},"ontologies":[],"galaxy_base":"http://galaxy.berkeleybop.org/","sources":[],"golr_base":"http://localhost:8080/solr/","species":[],"image_base":"http://localhost:9999/static/images","term_regexp":"all|GO:[0-9]{7}"};
