...
amigo.data.server = function(){
    ...
    var meta_data = {"evidence_codes":{},"app_base":"http://localhost:9999","gp_types":[],"species_map":{},"sources":[],"species":[],"term_regexp":"all|GO:[0-9]{7}","js_dev_base":"http://localhost:9999/static/staging","js_base":"http://localhost:9999/static/js","css_base":"http://localhost:9999/static/css","image_base":"http://localhost:9999/static/images","bbop_img_star":"http://localhost:9999/static/images/star.png","golr_base":"http://localhost:8080/solr/","ontologies":[],"galaxy_base":"http://galaxy.berkeleybop.org/","html_base":"http://localhost:9999/static","beta":"1"};
