...
amigo.data.server = function(){
    ...
    var meta_data = {"image_base":"http://localhost:9999/static/images","ontologies":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","species":[],"evidence_codes":{},"galaxy_base":"http://galaxy.berkeleybop.org/","html_base":"http://localhost:9999/static","sources":[],"gp_types":[],"css_base":"http://localhost:9999/static/css","js_dev_base":"http://localhost:9999/static/staging","beta":"1","term_regexp":"all|GO:[0-9]{7}","golr_base":"http://localhost:8080/solr/","species_map":{},"js_base":"http://localhost:9999/static/js","app_base":"http://localhost:9999"};
