...
amigo.data.server = function(){
    ...
    var meta_data = {"ontologies":[],"term_regexp":"all|GO:[0-9]{7}","html_base":"http://localhost:9999","bbop_img_star":"http://localhost:9999/images/star.png","golr_base":"http://localhost:8080/solr/","gp_types":[],"image_base":"http://localhost:9999/images","css_base":"http://localhost:9999/css","app_base":"http://localhost:9999","js_base":"http://localhost:9999/js","species_map":{},"evidence_codes":{},"sources":[],"species":[],"beta":"1","galaxy_base":null,"javascript_base":null};
     ...
     * 
     * Access to AmiGO variable javascript_base.
     * 
     * Parameters:
     *  n/a
     * 
     ...
     *  string
     */
    var javascript_base = meta_data.javascript_base;
    this.javascript_base = function(){ return javascript_base; };
