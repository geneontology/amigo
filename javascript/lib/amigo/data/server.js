...
amigo.data.server = function(){
    ...
    var meta_data = {"beta":"1","css_base":"http://localhost:9999/static/css","ontologies":[],"term_regexp":"all|GO:[0-9]{7}","species_map":{},"galaxy_base":null,"evidence_codes":{},"bbop_img_star":"http://localhost:9999/static/images/star.png","gp_types":[],"js_dev_base":"http://localhost:9999/static/staging","js_base":"http://localhost:9999/static/js","sources":[],"golr_base":"http://localhost:8080/solr/","html_base":"http://localhost:9999/static","species":[],"image_base":"http://localhost:9999/static/images","app_base":"http://localhost:9999"};
