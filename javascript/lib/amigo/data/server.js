...
amigo.data.server = function(){
    ...
    var meta_data = {"galaxy_base":"http://galaxy.berkeleybop.org/","species_map":{},"species":[],"beta":"1","evidence_codes":{},"app_base":"http://localhost:9999","js_dev_base":"http://localhost:9999/static/staging","bbop_img_star":"http://localhost:9999/static/images/star.png","sources":[],"gp_types":[],"ontologies":[],"css_base":"http://localhost:9999/static/css","golr_base":"http://localhost:8080/solr/","js_base":"http://localhost:9999/static/js","image_base":"http://localhost:9999/static/images","term_regexp":"all|GO:[0-9]{7}","html_base":"http://localhost:9999/static","noctua_base":"http://noctua.berkeleybop.org/"};
