...
amigo.data.server = function(){
    ...
    var meta_data = {"term_regexp":"all|GO:[0-9]{7}","sources":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","app_base":"http://localhost:9999","golr_base":"http://localhost:8080/solr/","evidence_codes":{},"js_dev_base":"http://localhost:9999/static/staging","gp_types":[],"js_base":"http://localhost:9999/static/js","ontologies":[],"species_map":{},"galaxy_base":"http://galaxy.berkeleybop.org/","beta":"1","image_base":"http://localhost:9999/static/images","species":[],"css_base":"http://localhost:9999/static/css","html_base":"http://localhost:9999/static"};
