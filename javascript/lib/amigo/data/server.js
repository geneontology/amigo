...
amigo.data.server = function(){
    ...
    var meta_data = {"sources":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","beta":"1","evidence_codes":{},"golr_base":"http://localhost:8080/solr/","js_base":"http://localhost:9999/static/js","species":[],"html_base":"http://localhost:9999/static","js_dev_base":"http://localhost:9999/static/staging","app_base":"http://localhost:9999","galaxy_base":"http://galaxy.berkeleybop.org/","species_map":{},"css_base":"http://localhost:9999/static/css","gp_types":[],"ontologies":[],"term_regexp":"all|GO:[0-9]{7}","image_base":"http://localhost:9999/static/images"};
