...
amigo.data.server = function(){
    ...
    var meta_data = {"html_base":"http://localhost:9999/static","evidence_codes":{},"galaxy_base":"http://galaxy.berkeleybop.org/","js_dev_base":"http://localhost:9999/static/staging","js_base":"http://localhost:9999/static/js","app_base":"http://localhost:9999","species_map":{},"beta":"1","css_base":"http://localhost:9999/static/css","term_regexp":"all|GO:[0-9]{7}","noctua_base":"http://noctua.berkeleybop.org/","bbop_img_star":"http://localhost:9999/static/images/star.png","ontologies":[],"gp_types":[],"golr_base":"http://localhost:8080/solr/","image_base":"http://localhost:9999/static/images","species":[],"sources":[]};
