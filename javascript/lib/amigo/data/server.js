...
amigo.data.server = function(){
    ...
    var meta_data = {"image_base":"http://localhost:9999/static/images","term_regexp":"all|GO:[0-9]{7}","golr_base":"http://localhost:8080/solr/","species":[],"css_base":"http://localhost:9999/static/css","sources":[],"js_dev_base":"http://localhost:9999/static/staging","beta":"1","ontologies":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","js_base":"http://localhost:9999/static/js","species_map":{},"app_base":"http://localhost:9999","evidence_codes":{},"gp_types":[],"html_base":"http://localhost:9999/static","galaxy_base":"http://galaxy.berkeleybop.org/"};
