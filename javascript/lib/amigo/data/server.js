...
amigo.data.server = function(){
    ...
    var meta_data = {"species":[],"image_base":"http://localhost:9999/static/images","html_base":"http://localhost:9999/static","gp_types":[],"galaxy_base":null,"bbop_img_star":"http://localhost:9999/static/images/star.png","app_base":"http://localhost:9999","species_map":{},"golr_base":"http://localhost:8080/solr/","js_base":"http://localhost:9999/static/js","sources":[],"beta":"1","ontologies":[],"evidence_codes":{},"css_base":"http://localhost:9999/static/css","js_dev_base":"http://localhost:9999/static/staging","term_regexp":"all|GO:[0-9]{7}"};
