...
amigo.data.server = function(){
    ...
    var meta_data = {"html_base":"http://localhost:9999/static","app_base":"http://localhost:9999","species":[],"term_regexp":"all|GO:[0-9]{7}","beta":"1","js_dev_base":"http://localhost:9999/static/staging","js_base":"http://localhost:9999/static/js","species_map":{},"sources":[],"gp_types":[],"image_base":"http://localhost:9999/static/images","bbop_img_star":"http://localhost:9999/static/images/star.png","css_base":"http://localhost:9999/static/css","ontologies":[],"evidence_codes":{},"golr_base":"http://localhost:8080/solr/","galaxy_base":"http://galaxy.berkeleybop.org/"};
