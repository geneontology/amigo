...
amigo.data.server = function(){
    ...
    var meta_data = {"css_base":"http://localhost:9999/static/css","app_base":"http://localhost:9999","species_map":{},"beta":"1","image_base":"http://localhost:9999/static/images","golr_base":"http://localhost:8080/solr/","species":[],"js_dev_base":"http://localhost:9999/static/staging","evidence_codes":{},"html_base":"http://localhost:9999/static","js_base":"http://localhost:9999/static/js","ontologies":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","galaxy_base":"http://galaxy.berkeleybop.org/","sources":[],"gp_types":[],"term_regexp":"all|GO:[0-9]{7}"};
