...
amigo.data.server = function(){
    ...
    var meta_data = {"evidence_codes":{},"galaxy_base":"http://galaxy.berkeleybop.org/","js_base":"http://localhost:9999/static/js","beta":"1","golr_base":"http://localhost:8080/solr/","bbop_img_star":"http://localhost:9999/static/images/star.png","sources":[],"species":[],"html_base":"http://localhost:9999/static","gp_types":[],"ontologies":[],"image_base":"http://localhost:9999/static/images","term_regexp":"all|GO:[0-9]{7}","app_base":"http://localhost:9999","css_base":"http://localhost:9999/static/css","species_map":{},"js_dev_base":"http://localhost:9999/static/staging"};
