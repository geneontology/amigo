...
amigo.data.server = function(){
    ...
    var meta_data = {"css_base":"http://localhost:9999/static/css","js_base":"http://localhost:9999/static/js","species":[],"evidence_codes":{},"ontologies":[],"app_base":"http://localhost:9999","js_dev_base":"http://localhost:9999/static/staging","beta":"1","image_base":"http://localhost:9999/static/images","sources":[],"gp_types":[],"galaxy_base":"http://galaxy.berkeleybop.org/","golr_base":"http://localhost:8080/solr/","bbop_img_star":"http://localhost:9999/static/images/star.png","term_regexp":"all|GO:[0-9]{7}","html_base":"http://localhost:9999/static","species_map":{}};
