...
amigo.data.server = function(){
    ...
    var meta_data = {"term_regexp":"all|GO:[0-9]{7}","beta":"1","js_base":"http://localhost:9999/static/js","bbop_img_star":"http://localhost:9999/static/images/star.png","species":[],"galaxy_base":null,"html_base":"http://localhost:9999/static","css_base":"http://localhost:9999/static/css","golr_base":"http://localhost:8080/solr/","evidence_codes":{},"species_map":{},"app_base":"http://localhost:9999","gp_types":[],"image_base":"http://localhost:9999/static/images","js_dev_base":"http://localhost:9999/static/staging","sources":[],"ontologies":[]};
