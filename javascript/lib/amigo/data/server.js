...
amigo.data.server = function(){
    ...
    var meta_data = {"evidence_codes":{},"galaxy_base":"http://galaxy.berkeleybop.org/","js_dev_base":"http://localhost:9999/static/staging","gp_types":[],"app_base":"http://localhost:9999","term_regexp":"all|GO:[0-9]{7}","noctua_base":"http://noctua.berkeleybop.org/","sources":[],"html_base":"http://localhost:9999/static","browse_filter_idspace":"GO","ontologies":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","image_base":"http://localhost:9999/static/images","beta":"1","css_base":"http://localhost:9999/static/css","golr_base":"http://localhost:8080/solr/","species":[],"species_map":{},"js_base":"http://localhost:9999/static/js"};
