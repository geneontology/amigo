...
amigo.data.server = function(){
    ...
    var meta_data = {"species_map":{},"bbop_img_star":"http://localhost:9999/static/images/star.png","image_base":"http://localhost:9999/static/images","html_base":"http://localhost:9999/static","css_base":"http://localhost:9999/static/css","term_regexp":"all|GO:[0-9]{7}","js_base":"http://localhost:9999/static/js","evidence_codes":{},"golr_base":"http://localhost:8080/solr/","ontologies":[],"species":[],"galaxy_base":"http://galaxy.berkeleybop.org/","app_base":"http://localhost:9999","gp_types":[],"js_dev_base":"http://localhost:9999/static/staging","sources":[],"beta":"1"};
