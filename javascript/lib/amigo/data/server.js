...
amigo.data.server = function(){
    ...
    var meta_data = {"image_base":"http://localhost:9999/static/images","term_regexp":"all|GO:[0-9]{7}","galaxy_base":"http://galaxy.berkeleybop.org/","gp_types":[],"js_dev_base":"http://localhost:9999/static/staging","golr_base":"http://localhost:8080/solr/","sources":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","evidence_codes":{},"html_base":"http://localhost:9999/static","species_map":{},"css_base":"http://localhost:9999/static/css","app_base":"http://localhost:9999","species":[],"beta":"1","ontologies":[],"js_base":"http://localhost:9999/static/js"};
