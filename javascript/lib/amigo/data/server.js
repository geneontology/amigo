...
amigo.data.server = function(){
    ...
    var meta_data = {"term_regexp":"all|GO:[0-9]{7}","species":[],"sources":[],"html_base":"http://localhost:9999/static","ontologies":[],"bbop_img_star":"http://localhost:9999/static/images/star.png","golr_base":"http://localhost:8080/solr/","beta":"1","js_base":"http://localhost:9999/static/js","galaxy_base":null,"image_base":"http://localhost:9999/static/images","gp_types":[],"css_base":"http://localhost:9999/static/css","js_dev_base":"http://localhost:9999/static/staging","app_base":"http://localhost:9999","species_map":{},"evidence_codes":{}};
