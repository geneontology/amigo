...
amigo.data.server = function(){
    ...
    var meta_data = {"gp_types":[],"species_map":{},"html_base":"http://localhost:9999/static","sources":[],"js_dev_base":"http://localhost:9999/static/staging","js_base":"http://localhost:9999/static/js","bbop_img_star":"http://localhost:9999/static/images/star.png","app_base":"http://localhost:9999","image_base":"http://localhost:9999/static/images","species":[],"golr_base":"http://localhost:8080/solr/","beta":"1","css_base":"http://localhost:9999/static/css","galaxy_base":"http://galaxy.berkeleybop.org/","term_regexp":"all|GO:[0-9]{7}","ontologies":[],"evidence_codes":{}};
