...
amigo.data.server = function(){
    ...
    var meta_data = {"css_base":"http://localhost:9999/static/css","app_base":"http://localhost:9999","golr_base":"http://localhost:8080/solr/","image_base":"http://localhost:9999/static/images","term_regexp":"all|GO:[0-9]{7}","beta":"1","gp_types":[],"noctua_base":"http://noctua.berkeleybop.org/","sources":[],"evidence_codes":{},"html_base":"http://localhost:9999/static","bbop_img_star":"http://localhost:9999/static/images/star.png","js_dev_base":"http://localhost:9999/static/staging","galaxy_base":"http://galaxy.berkeleybop.org/","species_map":{},"ontologies":[],"species":[],"js_base":"http://localhost:9999/static/js"};
