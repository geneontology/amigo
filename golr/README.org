...
** Solr schema
   ...
   : ~/local/src/git/owltools/OWLTools-Runner/bin/owltools --solr-config ~/local/src/git/amigo/metadata/ont-config.yaml ~/local/src/git/amigo/metadata/bio-config.yaml ~/local/src/git/amigo/metadata/ann_ev_agg-config.yaml ~/local/src/git/amigo/metadata/general-config.yaml ~/local/src/git/amigo/metadata/model-ann-config.yaml ~/local/src/git/amigo/metadata/noctua-model-meta-config.yaml ~/local/src/git/amigo/metadata/protein-family-config.yaml ~/local/src/git/amigo/metadata/ann-config.yaml ~/local/src/git/amigo/metadata/bio-config.browse.yaml ~/local/src/git/amigo/metadata/ann-config.browse.yaml --solr-schema-dump > ~/local/src/git/amigo/golr/solr/conf/schema.xml
** Experimental
   : sudo ./tools/golr.el
